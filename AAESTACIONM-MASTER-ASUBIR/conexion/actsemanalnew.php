...
try {
    ...
    function calcularrModa($valores) {
    ...
    foreach ($weeks as $weekKey => $values) {
        ...
        if ($rowCount == 0) {
            ...
            $moda_veleta = calcularrModa($values['moda_veleta']); // Moda de la veleta (dirección del viento más frecuente)
    ...
    echo "Datos semanales procesados y almacenados correctamente.";
} catch (Exception $e) {
